    ...
    return (
        <div className="container-fluid">
            <div className="row d-flex justify-content-around">
                <div className='col-lg-4 col-md-4 col-12 d-flex justify-content-center mt-5'>
                ...
                <div className='col-lg-7 col-md-8 col-10 cart-items-col'>
                    <div className='row pb-5'>
                        ...
                        )) : <div className='col-12 my-5'><h2 className='text-center'>Cart is empty <MdOutlineRemoveShoppingCart size={40} /></h2><h2 className='text-center text-muted'>Add some items in your cart</h2></div>}
                    </div>
                </div>
            </div>
        </div>
